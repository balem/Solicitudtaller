   ...
   private void confGrilla(){
    ...
    private void cargaGilla(){
        try {
            ...
            Logger.getLogger(FrmRubro.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void modificar(){
        try {
            String sql ="UPDATE rubro SET descripcion = '"+
    ...
    private void borrar(){
        try {
            String sql = "DELETE FROM rubro WHERE id = "+txtCodigo.getText();
            z.snt = z.con.createStatement();
            z.snt.executeUpdate(sql);
        } catch (SQLException ex) {
            Logger.getLogger(FrmRubro.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        pnlProveedor.setBorder(javax.swing.BorderFactory.createTitledBorder("Rubro"));
