...
public class FrmBien extends javax.swing.JFrame {
   ...
   private void confGrilla(){
    ...
    private void cargaGilla(){
        try {
            String sql = "SELECT id, descripcion FROM bien;";
            ...
            Logger.getLogger(FrmBien.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void modificar(){
        try {
            String sql ="UPDATE bien SET descripcion = '"+
    ...
    private void borrar(){
        try {
            String sql = "DELETE FROM bien WHERE id = "+txtCodigo.getText();
            z.snt = z.con.createStatement();
            z.snt.executeUpdate(sql);
        } catch (SQLException ex) {
            Logger.getLogger(FrmBien.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        pnlProveedor.setBorder(javax.swing.BorderFactory.createTitledBorder("Bien"));
