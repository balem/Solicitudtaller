...
public class FrmCiudad extends javax.swing.JFrame {
   ...
   private void confGrilla(){
    ...
    private void modificar(){
        try {
            String sql ="UPDATE ciudad SET descripcion = '"+
    ...
    private void borrar(){
        try {
            String sql = "DELETE FROM ciudad WHERE id = "+txtCodigo.getText();
            z.snt = z.con.createStatement();
            z.snt.executeUpdate(sql);
        } catch (SQLException ex) {
            Logger.getLogger(FrmCiudad.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        pnlProveedor.setBorder(javax.swing.BorderFactory.createTitledBorder("Ciudad"));
